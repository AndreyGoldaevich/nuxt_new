  ...
  <div id="contact" class="panel box">
    <div class="in">
      ...
      <div class="two-fifths">
        <p>
          Если у вас есть иетересные предложения по сотрудничеству не стесняйтесь обращаться.
        </p>

        <address>
          Email: gurupredator@gmail.com
        </address>
      ...
      <div class="three-fifths column-last">
        ...
        >
          <input type="hidden" name="_next" value="https://gurupredator@gmail.com" />
